...
return (
  <div>
    <div className="bg-white max-w-9xl font-sans mx-auto px-4 md:px-6 lg:px-10 pb-6">
      <h1
        className={`pt-6 font-castoro text-4xl font-extrabold ${bigShoulders.className}`}
      >
      ...
      <section className="mb-6 mt-4">
        ...
        <div>
          ...
          <p>
            ...
            to you, how you or we may change or end the contract, what to do
            if there is a problem and other important information. If you
            think that there is a mistake in these terms, please contact us to
            discuss this, by any of the methods listed in clause 2.1.
          </p>
          <p>
            1.3 <br />
          ...
          <p>
            ...
            agreement between us in relation to your purchase. You acknowledge
            that you have not relied on any statement, promise,
      ...
      <section className="mb-4">
        ...
        <div>
          <p>
            ...
            Industrial Estate, Corby, Northamptonshire, NN18 8AL, or by email
            to{" "}
            <a
      ...
      <section className="mb-4">
        ...
        <div>
          ...
          <p>
            ...
            quote your order number whenever you contact us about your order.
          </p>
          <p>
            ...
            placing your order and we will advise you as to whether we will be
            able to deliver the products to you. If you require the products
            to be delivered to an address in Northern Ireland, then please
            note that the delivery provisions stated in these terms may vary.
            Please contact us prior to placing your order and we can advise
            you further.
          </p>
        </div>
      </section>
      ...
      <section className="mb-4">
        ...
        <div>
          ...
          <div>
            ...
            <ol>
              ...
              <li>
                ...
                date for the services will be notified to you during the order
                process; and
              </li>
              <li>
          ...
          <p>
            ...
            you for storage costs and any further delivery costs. If, despite
            our reasonable efforts, we are unable to contact you or rearrange
            delivery or collection, we may end the contract and clause 13.2
            will apply.
          </p>
          <p>
            7.5 <br />
      ...
      <section className="mb-4">
        ...
        <div>
          ...
          <p>
            8.2
            <br /> If we miss the delivery deadline for any products then you
            may treat the contract as at an end straight away if any of the
            following apply:
          </p>
          <ol>
          ...
          <p>
            ...
            straight away, or do not have the right to do so under clause 8.2
            you can give us a new deadline for delivery, which must be
          ...
          <p>
            ...
            late delivery under clause 8.2 or clause 8.3, you can cancel your
            order for any of the products or reject products that have been
            delivered. If you wish, you can reject or cancel the order for
            some of those products (not all of them), unless splitting them up
            would significantly reduce their value. After that we will refund
            any sums you have paid to us for the cancelled products and their
            delivery. If the products have been delivered to you, you will
            have to return them to us or allow us to collect them, and we will
      ...
      <section className="mb-4">
        ...
        <div>
          ...
          <p>
            ...
            available. We shall not be liable for any delay in delivery that
            is due to a reason beyond our reasonable control or if you fail to
            provide us with adequate delivery instructions that are relevant
      ...
      <section className="mb-4">
        ...
        <div>
          <p>
            10.1 <br />
            The goods will be your responsibility on completion of delivery of
            the goods and you own the goods once we have received payment for
            the goods in full (subject to clause 10.3 if you are a business
            customer and clause 10.2 and 10.3 applies).
          </p>
          <p>
            10.2
            ...
            goods in our warehouse, allow you to take possession of the goods
            for your use or resale, subject to our consignment terms and
            conditions, but retain ownership of such goods until they are paid
            for by the applicable customer{" "}
            <strong>(Consignment Goods). </strong>
            In this instance, we will require you to enter into our
            consignment terms and conditions, which will apply in addition to
          ...
          <p>
            ...
            in addition to these terms and conditions, in relation to any such
            Consignment Goods:
          </p>
          <p>
      ...
      <section className="mb-4">
        ...
        <div>
          ...
          <p>
            11.3
            <br /> Whether the price stated includes value-added tax (VAT) or
            not will be stated on each product and our acknowledgment of your
            order.
          </p>
          <p>
            11.4
          ...
          <p>
            11.5
            <br /> If the rate of VAT changes between your order date and the
            date we supply the product, we will adjust the rate of VAT that
            you pay, unless you have already paid for the product in full
          ...
          <p>
            11.7
            <br /> For some of our business customers, we are able to offer a
            trade account, where we are able to offer more favourable payment
            terms. Should you wish to apply for a trade account with us,
            please contact us. We will notify you in writing to confirm
          ...
          <p>
            ...
            have a trade account with us, then the price for the products will
            be payable on collection or delivery of the goods (as the case may
            be). However, if you order any customised/bespoke products, or any
            non-standard items (these are goods which we would not normally
            stock but have stocked these upon your request) then these
            products must be paid for by you at the time you place your order.
          </p>

          <p>
            11.9
            <br /> No payment will be deemed to have been received by us until
            payment is received in full and clear funds.
          </p>
          ...
          <p>
            11.11
            <br /> We can charge interest if you pay late, what we can charge
            you depends if you are a business or consumer customer:
          </p>
          ...
          <p>
            11.12 <br />
            If you think an invoice is wrong please contact us promptly to let
            us know. You will not have to pay any interest until the dispute
            is resolved. Once the dispute is resolved we will charge you
      ...
      <section className="mb-4">
        ...
        <div>
          <p>
            ...
            information within a reasonable time of us asking for it, or if
            you give us incomplete or incorrect information, we may either end
            the contract (and clause 13.2 will apply) or make an additional
            charge of a reasonable sum to compensate us for any extra work
            that is required as a result. We will not be responsible for
            supplying the products late, or not supplying any part of them, if
            this is caused by you not giving us the information we need within
            a reasonable time of us asking for it.
          </p>
          <div>
            12.2 <br />
          ...
          <p>
            ...
            to end the contract for a product if we suspend it, or tell you we
            are going to suspend it in each case for a period of more than ten
            days and we will refund any sums you have paid in advance for the
          ...
          <p>
            ...
            you to tell you we are suspending supply of the products. We will
            not suspend the products where you dispute the unpaid invoice (see
            clause 11.12) providing that you notify us as soon as possible as
            soon as you become aware of the same. We will not charge you for
            the products during the period for which they are suspended. As
            well as suspending the products we can also charge you interest on
            your overdue payments (see clause 11.11).
          </p>
        </div>
      </section>
      ...
      <section className="mb-4">
        ...
        <div>
              ...
              <li>
                ...
                <ol>
                  <li>
                    ...
                    any composition or arrangement with your creditors (other
                    than in relation to a solvent restructuring), being wound
                  ...
                  <li>
                    ...
                    suspend payment of any of your debts, or are unable to, or
                    you admit your inability to, pay your debts as they fall
                    due.
                  </li>
                </ol>
              </li>
          ...
          <p>
            ...
            will refund any money you have paid in advance for products we
            have not provided but we may deduct reasonable compensation for
            the net costs we will incur as a result of you breaking the
            contract.
          </p>
          ...
          <p>
            ...
            time in advance and will refund any sums you have paid in advance
      ...
      <section className="mb-4">
        ...
        <div className="space-y-2 mt-2">
          <p>
            ...
            end the contract and whether you are a consumer customer or
            business customer:
          </p>
          <ol>
            <li>
              ...
              repaired or replaced or a service re-performed or to get some or
              all of your money back), please see clause 17 if you are a
            ...
            <li>
              ...
              you are within the cooling-off period, but this may be subject
              to deductions and you will have to pay the costs of return of
              any goods; or
            </li>
        ...
        <div className="space-y-2 mt-2">
          <p>
            ...
            full for any products which have not been provided and you may
        ...
        <div className="space-y-2 mt-2">
          ...
          <ol>
            <li>
              (a) then for most products bought online you have a legal right
              to change your mind within 14 days and receive a refund. These
              ...
              You may wish to use the model cancellation form, which is
            ...
            <ol className="  mb-4">
              ...
              <li>
                ...
                computer software, once these products are unsealed after you
                receive them; and
              </li>
          ...
          <ol>
            <li>
              (i) If you have bought services, you have 14 days after the day
              we email you to confirm we accept your order. However, once we
              have completed the services you cannot change your mind, even if
              the period is still running. If you cancel after we have started
              the services, you must pay us for the services provided up until
              the time you tell us that you have changed your mind; and
            </li>
            <li>
              (ii) If you have bought goods, you have 14 days after the day
              you (or someone you nominate) receives the goods, unless your
              goods are split into several deliveries over different days. In
              this case you have until 14 days after the day you (or someone
              you nominate) receives the last delivery or your goods. If your
              goods are for regular delivery over a set period. In this case
        ...
        <div className="space-y-2 mt-2">
          <p>
            ...
            right to change your mind. Even if we are not at fault and you are
            not a consumer who has a right to change their mind (see clause
            14.1), you can still end the contract before it is completed, but
            you may have to pay us compensation. A contract for goods is
            completed when the product is delivered. A contract for services
            is completed when we have finished providing the services and you
            have paid for them. If you want to end a contract before it is
            completed where we are not at fault and you are not a consumer who
            has changed their mind, just contact us to let us know. The
            contract will end immediately and we will refund any sums paid by
            you for products not provided but we may deduct from that refund
            (or, if you have not made an advance payment, charge you)
            reasonable compensation for the net costs we will incur as a
            result of you ending the contract. Unfortunately, if you have
            ordered customised/ bespoke goods, such as goods containing your
            logo or business name, you are not entitled to return these items
            unless they are defective. In addition, if you have ordered
            undergarments or thermal underwear you are not able to return
            these goods unless they are defective and unworn. Any footwear
            must be returned to us in the original condition and unworn,
      ...
      <section className="my-4">
        ...
        <div>
          ...
          <p>
            15.2
            <br /> If you end the contract for any reason after products have
            been dispatched to you or you have received them, you must return
            them to us. You must either return the goods in person to where
            you bought them, post them back to us, or (if they are not
            suitable for posting) allow us to collect them from you. If you
            are a consumer exercising your right to change your mind, you must
            send off the goods within 14 days of telling us you wish to end
            the contract.
          </p>
          <div>
            <p>
            ...
            <ol>
              ...
              <li>
                ...
                exercising your right to change your mind) you must pay the
                costs of return.
              </li>
            </ol>
          </div>
          ...
          <p>
            15.5
            <br /> If you are entitled to a refund under these terms, we will
            refund you the price you paid for the products, including delivery
            costs, by the method you used for payment. However, we may make
          ...
          <div>
            ...
            <ol>
              ...
              <li>
                ...
                refund an amount for the supply of the service for the period
                for which it was supplied, ending with the time when you told
                us you had changed your mind. The amount will be in proportion
                to what has been supplied, in comparison with the full
            ...
            <ol>
              <li>
                ...
                collect them, your refund will be made within 14 days from the
                day on which we receive the product back from you or, if
        ...
        <section id="consumer-rights" className="mb-4">
          ...
          <p>
            17.1
            <br /> If you are a consumer customer we are under a legal duty to
            supply products that are in conformity with this contract. See the
            box below for a summary of your key legal rights in relation to
            the products. Nothing in these terms will affect your legal
            rights.
          </p>
...
Please note that all of our goods are off the shelf products and we make no representation or give any warranty that the goods are fit for a particular purpose. You should satisfy yourself that any goods you purchase from us are for the purpose you require.`}
          ...
          <p>
            ...
            bought them, post them back to us or (if they are not suitable for
            posting) allow us to collect them from you. We will pay the costs
            of postage or collection.
          </p>
        </section>
        ...
        <section id="business-rights" className="mb-8">
          ...
          <p>
            18.1
            <br /> If you are a business customer we warrant that on delivery
            of the goods and for such period as is stated on the applicable
            goods <strong> (Warranty Period) </strong>
          ...
          <p>
            ...
            particular purpose. You should satisfy yourself that any goods you
            purchase from us are for the purpose you require.
          </p>
          <p>
            18.2
          ...
          <p>
            (a) <br />
            you give us notice in writing during the Warranty Period within a
            reasonable time of discovery that a product does not comply with
          ...
          <p>
            (a) <br />
            you make any further use of such product after giving a notice in
            accordance with clause 18.2(a);
          </p>

          <p>
            (b) <br />
            the defect arises because you failed to follow our oral or written
            instructions as to the storage, installation, commissioning, use
            or maintenance of the product or (if there are none) good trade
            practice;
          </p>

          <p>
            (c) <br />
            the defect arises as a result of us following any drawing, design
            or specification supplied by you;
          </p>
...
`}
        ...
        <section id="consumer-liability" className="mb-4">
          ...
          <p>
            19.2
            <br /> We do not exclude or limit in any way our liability to you
          ...
          <p>
            ...
            providing services in your property, we will make good any damage
            to your property caused by us while doing so. However, we are not
            responsible for the cost of repairing any pre-existing faults or
            damage to your property that we discover while providing the
            services.
          </p>
      ...
      <div className="mb-4">
        ...
        <ol>
          <li>
            ...
            providing the goods and/or services to you; and
          </li>
          <li>
      ...
      <div className="mb-4">
        ...
        <ol>
          <li>
            23.1 <br /> We may transfer our rights and obligations under these
