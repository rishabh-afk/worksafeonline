...
const SocialConnect: React.FC = () => {
  ...
  return (
    <div
      className={`max-w-9xl px-10 py-8 mx-auto text-xl md:text-2xl flex flex-col lg:flex-row gap-3 justify-between items-center text-white font-bold ${bigShoulders.className}`}
    >
